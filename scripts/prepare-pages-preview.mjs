...
const prerenderFiles = [
  ...
  "src/pages/individual/configurator/index.astro",
  "src/pages/individual/internet/index.astro",
  "src/pages/individual/tv/index.astro",
  "src/pages/individual/cctv/index.astro",
