...
export const promoVisuals = {
  ...
  documents: {
    src: "/visuals/documents-review.png",
    alt: "Специалист внимательно изучает документы за рабочим столом",
    label: "Понятные документы",
    caption: "Условия и реквизиты собраны в одном месте."
  },
  news: {
    src: "/visuals/news-information-flow.png",
    alt: "Абстрактные потоки уведомлений, расходящиеся от одного источника к связанным карточкам",
    label: "Официальные сообщения",
    caption: "Важные изменения собраны в одном месте."
  },
  cafeWifi: {
