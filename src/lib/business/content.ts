...
export const businessSegments: BusinessSegment[] = [
  ...
  },
  {
    ...
    pain: "Государственному заказчику нужен поставщик связи, который работает через ЕИС, федеральные ЭТП и закупочные процедуры.",
    trigger:
      "Закупка услуг связи, подготовка документации, участие в процедуре на ЭТП или запрос вне торговой площадки.",
    ctaLabel: "Связаться с сектором B2G",
    fields: ["учреждение", "закон закупки", "ЭТП", "услуги связи", "срок процедуры"],
