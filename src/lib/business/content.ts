...
export const businessServices: BusinessService[] = [
  ...
  },
  {
    ...
    seoTitle: "Телефония для бизнеса в\u00a0Краснодаре",
    seoDescription:
      "Телефония Kubtel для бизнеса: виртуальная АТС, многоканальный телефон, номера, линии и заявка на подбор конфигурации."
  },
  {
    slug: "cctv",
