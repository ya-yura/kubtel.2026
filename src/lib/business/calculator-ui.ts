...
export const businessCalculatorConfigs: Record<CalculatorType, BusinessCalculatorConfig> = {
  telephony: {
    ...
    sourceNote: [
      "Все суммы в калькуляторах телефонии указаны с учётом НДС.",
      "Платежи за местный трафик при повременной тарификации вызовов оплачиваются отдельно и не входят в фиксированную абонентскую плату.",
      "Платежи за внутризоновый, междугородный и международный трафик оплачиваются отдельно по тарифам операторов дальней связи и не входят в фиксированную абонентскую плату.",
      "Доступна услуга «Выбор номера», она рассчитывается индивидуально в зависимости от категории номера."
    ],
...
export const telephonyCalculatorConfigs: Record<TelephonyVariant, BusinessCalculatorConfig> = {
  basic: {
    ...
    lead: "Выберите тип подключения и тариф.",
    submitLabel: "Оставить заявку",
